...
class User implements UserInterface
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="emai", type="string", length=255, nullable=true)
     * @Assert\NotBlank
     * @Assert\Email(
     *      message = " El correo electronico '{{ value }}' no es valido por el sistema",
     *           
     * )
     */
    private $emai;
    ...
    */
    private $tasks;
    // guardara una coleccion de datos en doctrine
